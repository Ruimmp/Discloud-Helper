...
<div class="bg-[#0b0b0b] text-white">
  <div class="py-12 text-center">
    ...
    <h1 class="text-3xl font-bold text-[#57f287]">
  ...
  <main class="mx-auto max-w-6xl px-6">
    <h2 class="text-2xl font-semibold text-[#57f287]">
    ...
    <div class="mt-6 grid grid-cols-1 gap-6 md:grid-cols-2">
      ...
      <div class="rounded-lg bg-[#1c1c1c] p-6 shadow-md">
        <h3 class="text-xl font-semibold text-[#57f287]">
          {$t.landing.functionalities.tools.generateDiscordApplicationInvite
            .title}
        </h3>
        <p class="mt-2 text-gray-300">
          {@html $t.landing.functionalities.tools
            .generateDiscordApplicationInvite.description}
        </p>
        <a
