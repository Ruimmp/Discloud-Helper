export default {
  ...
  botInvite: {
    ...
    guide: {
      ...
      step4:
        'Collez-le ci-dessous et configurez les portées et les permissions.',
    ...
    form: {
      ...
      appMain: {
        ...
        error: {
          ...
          invalidExtension:
            'Type de fichier invalide. Veuillez utiliser une extension valide.',
          javaJar: 'Les projets Java doivent être compilés en un fichier .jar.',
          invalidJarName:
            'Utilisez uniquement des caractères alphanumériques (ex. app.jar).',
        },
        examples: {
          title: 'Exemples :',
      ...
      appVersion: {
        ...
        placeholder: {
          selectFile:
            'Fournissez le fichier principal pour voir les versions disponibles',
